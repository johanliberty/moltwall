        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              {[{icon: Github, href: "https://github.com/moltwall"}, {icon: Twitter, href: "https://x.com/moltfirewall?s=21"}, {icon: MessageCircle, href: "https://discord.gg/moltwall"}, {icon: Mail, href: "mailto:hello@moltwall.xyz"}].map((social, i) => (
